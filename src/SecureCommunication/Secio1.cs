...
#pragma warning disable VSTHRD103
		...
		public async Task<Stream> EncryptAsync(PeerConnection connection, CancellationToken cancel = default)
		{
			...
			//log.Debug($"Secure session with {remotePeer}"); // TODO: Add logging back, but for now removed to avoid ctor injection
