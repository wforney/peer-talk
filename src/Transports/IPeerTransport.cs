namespace PeerTalk.Transports
{
	...
	/// <summary>
	/// Establishes a duplex stream between two peers over a specific network transport.
	/// </summary>
	public interface IPeerTransport
	{
		...
		/// <param name="cancel">Is used to stop the task. When cancelled, a <b>null</b> is returned.</param>
		/// <returns>
		/// A task that represents the asynchronous operation. The task's result is a duplex <see
		/// cref="Stream" /> or <b>null</b>.
		/// </returns>
		...
		/// <param name="cancel">
		/// Is used to stop the connection listener. When cancelled, the <see
		/// cref="OperationCanceledException" /> is <b>NOT</b> raised.
		/// </param>
		/// <returns>The actual address of the listener.</returns>
		/// <remarks>
		/// The <paramref name="handler" /> is invoked on the peer listener thread. If it throws,
