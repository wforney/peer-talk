...
namespace SharedCode.Notifications
{
	...
	public class NotificationService : INotificationService
	{
		...
		/// </summary>
		private readonly ProducerConsumer producerConsumer = new ProducerConsumer();
		...
		/// <inheritdoc />
		public void Publish<TNotification>(TNotification notification) where TNotification : Notification => this.producerConsumer.Produce(notification);
