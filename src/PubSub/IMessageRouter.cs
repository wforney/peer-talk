namespace PeerTalk.PubSub
{
	...
	public interface IMessageRouter : IService
	{
		...
		/// </summary>
		/// <param name="topic">The topic of interest or <b>null</b> for all topics.</param>
		/// <returns>
		/// A sequence of <see cref="Peer" /> that are subsribed to the <paramref name="topic" />.
		/// </returns>
		...
		/// </summary>
		/// <param name="topic">The topic of interested.</param>
		/// <param name="cancel">
