namespace PeerTalk
{
	...
	{
		private static readonly Dictionary<AddressFamily, string> supportedDnsAddressFamilies = new Dictionary<AddressFamily, string>();
		private static readonly MultiAddress http = new MultiAddress("/tcp/80");
		private static readonly MultiAddress https = new MultiAddress("/tcp/443");
